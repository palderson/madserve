...
if (isset($xml_response->Ads->Ad->ImageURL)) { $tempad['image']=$xml_response->Ads->Ad->ImageURL; } else {$tempad['image']='';}
if (isset($xml_response->Ads->Ad->AdURL)) { $tempad['url']=$xml_response->Ads->Ad->AdURL; } else {$tempad['url']='';}
if (isset($xml_response->Ads->Ad->BeaconURL)) { $tempad['pixel']=$xml_response->Ads->Ad->BeaconURL; } else {$tempad['pixel']='';}
if (isset($xml_response->Ads->Ad->LinkText)) { $tempad['text']=$xml_response->Ads->Ad->LinkText; } else {$tempad['text']='';}
