...
function ad_request($data){
    ...
    if (isset($data['cLat'])){
        $request_settings['cLat']=$data['cLat'];
    } else {
        $request_settings['cLat']='';
    }

    if (isset($data['cLog'])){
        $request_settings['cLog']=$data['cLog'];
    } else {
        $request_settings['cLog']='';
    }
...
function select_adunit_query($campaign_id){
    ...
    if(is_numeric($request_settings['cLat'])
        && is_numeric($request_settings['cLog'])){
