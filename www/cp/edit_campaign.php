...
<div id="content">		
		...
		<div class="container">
           ...
           <?php if ($edited==1){?>	
            <div class="box plain"><div class="notify notify-success"><h3>Successfully Updated</h3><p>Your Campaign has successfully been updated. <a href="view_campaigns.php">Back to Campaign List</a></p></div> <!-- .notify --></div>
