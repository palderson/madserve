...
if (do_update_data('profile', $_POST, $user_detail['user_id'])){
global $updated;
$updated=1;
...
<div id="content">		
		...
		<div class="container">
            ...
            <?php if ($updated==1){?>	
            <div class="box plain"><div class="notify notify-success"><h3>Successfully Updated</h3><p>Your Profile has successfully been updated.</p></div> <!-- .notify --></div>
					...
					<div class="widget">
						...
						<div class="widget-content">
							...
							<div class="field-group">			
								<div class="field">
									<input type="text" value="<?php echo $user_detail['first_name']; ?>" name="first_name" id="first_name" size="10" class="" />			
									<label for="first_name">First Name</label>
								</div>
								<div class="field">
									<input type="text" value="<?php echo $user_detail['last_name']; ?>" name="last_name" id="last_name" size="10" class="" />			
                            ...
                            <div class="field-group">
								...
								<div class="field">
									<input type="text" value="<?php echo $user_detail['email_address']; ?>" name="email_address" id="email_address" size="28" class="" />			
                             ...
                             <div class="field-group">
								...
								<div class="field">
									<input type="text" value="<?php echo $user_detail['company_name']; ?>" name="company_name" id="company_name" size="28" class="" />			
                            ...
                            <div class="field-group">
								...
								<div class="field">
									<input type="text" value="<?php echo $user_detail['phone_number']; ?>" name="phone_number" id="phone_number" size="28" class="" />			
                            ...
                            <div class="field-group">
								...
								<div class="field">
									<input type="text" value="<?php echo $user_detail['fax_number']; ?>" name="fax_number" id="fax_number" size="28" class="" />			
                            ...
                            <div class="field-group">			
								<div class="field">
									<input type="text" value="<?php echo $user_detail['company_address']; ?>" name="company_address" id="company_address" size="20" class="" />			
									<label for="company_address">Address</label>
								</div>
								<div class="field">
									<input type="text" value="<?php echo $user_detail['company_city']; ?>" name="company_city" id="company_city" size="10" class="" />			
                            ...
                            <div class="field-group">			
								<div class="field">
									<input type="text" value="<?php echo $user_detail['company_state']; ?>" name="company_state" id="company_state" size="10" class="" />			
									<label for="company_state">State</label>
								</div>
								<div class="field">
									<input type="text" value="<?php echo $user_detail['company_zip']; ?>" name="company_zip" id="company_zip" size="10" class="" />			
...
<?php if (empty($user_detail[company_country])){echo '<option value="" selected="selected">Select Country</option>'; } else { echo '<option value="'.$user_detail['company_country'].'" selected="selected">'.country_code_to_country($user_detail['company_country']).'</option>'; }?>
...
<option value="Zimbabwe">Zimbabwe</option>
                            ...
                            <div class="field-group">
								...
								<div class="field">
									<input type="text" value="<?php echo $user_detail['tax_id']; ?>" name="tax_id" id="tax_id" size="28" class="" />			
									<label for="tax_id">Tax ID</label>
								</div>
							</div> <!-- .field-group -->
                            
                            <div class="actions">						
									<button type="submit" class="btn btn-quaternary btn-large">Update Profile</button>
								</div> <!-- .actions -->
