...
<div id="content">		
		...
		<div class="container">
           ...
           <?php if ($edited==1){?>	
            <div class="box plain"><div class="notify notify-success"><h3>Successfully Updated</h3><p>Your Creative Server has successfully been updated. <a href="creative_servers.php">Back to Creative Server List</a></p></div> <!-- .notify --></div>
