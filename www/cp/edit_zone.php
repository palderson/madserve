...
if (do_edit('placement', $_POST, $_GET['id'])){
$edited=1;
MAD_Admin_Redirect::redirect('edit_zone.php?edited=1&id='.$_GET['id'].'');	
}
else
{
$edited=2;
...
if ($edited!=2){
$editdata=get_zone_detail($_GET['id']);
}
...
<div id="content">		
		...
		<div class="container">
           ...
           <?php if ($edited==1){?>	
            <div class="box plain"><div class="notify notify-success"><h3>Successfully Updated</h3><p>Your Placement has successfully been updated.</p></div> <!-- .notify --></div>
            ...
            <?php } ?>
				...
				<?php require_once MAD_PATH . '/www/cp/templates/forms/crud.zone.tpl.php';
